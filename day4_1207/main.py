...
def main():
    message_log = [
        {
            ...
            Please answer to the user’s question based on the attached file "./project_data_카카오톡채널.txt".
            Please recommend useful API for user's objective.
    ...
    functions = [
        {
            "name": "get_api_url",
            "description": "Get API for suggested question",
            "parameters": {
                "type": "object",
                "properties": {
                    "API_url_txt": {
                        "type": "string",
                        "description": "API URL for kakaotalk in txt format",
                    },
                },
                "required": ["API_url_txt"],
            },
        }
    ]
